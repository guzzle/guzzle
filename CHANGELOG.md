...
- Reject short buffered stream-handler bodies with valid positive
  `Content-Length` as `ResponseTransferException`, including decoded
  gzip/deflate
- Normalize duplicate `Content-Length` casings and preserve encoded values on
  decoded responses.
