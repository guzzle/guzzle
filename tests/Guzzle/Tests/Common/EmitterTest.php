...
class EmitterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDispatch()
    {
        ...
        $this->assertInstanceOf('Guzzle\Common\EventInterface', $this->emitter->emit(self::preFoo, new Event()));
        $event = new Event();
...
class TestEventSubscriber extends TestEventListener implements EventSubscriberInterface
{
...
class TestEventSubscriberWithPriorities extends TestEventListener implements EventSubscriberInterface
{
    public static function getSubscribedEvents()
    {
        return [
