...
/**
 * @covers Guzzle\Http\Subscriber\History
 */
class HistoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMaintainsLimitValue()
    {
        ...
        foreach ($h as $trans) {
            $this->assertInstanceOf('Guzzle\Http\Message\RequestInterface', $trans['request']);
            $this->assertInstanceOf('Guzzle\Http\Message\ResponseInterface', $trans['response']);
        }
        return $h;
    }
