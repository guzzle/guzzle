...
class CurlMultiHandlerTest extends TestCase
{
    ...
    /**
     * @dataProvider invalidSelectTimeoutProvider
     *
     * @param mixed $selectTimeout
     */
    public function testRejectsInvalidSelectTimeout($selectTimeout, string $message): void
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public static function invalidSelectTimeoutProvider(): array
    {
        return [
