...
class ProxyOptionsTest extends TestCase
{
    ...
    public static function noProxyProvider(): array
    {
        return [
            ...
            ['[fd00::1]', ['fd00::/8'], true],
            ['[fe80::1]', ['fd00::/8'], false],
            ['127.1', ['127.0.0.0/8'], true],
            ['127.0.0.01', ['127.0.0.0/8'], true],
            ['127.000.000.001', ['127.0.0.0/8'], true],
            ['2130706433', ['127.0.0.0/8'], true],
            ['0x7f000001', ['127.0.0.0/8'], true],
            ['0X7F000001', ['127.0.0.0/8'], true],
            ['0177.0.0.1', ['127.0.0.0/8'], true],
            ['017700000001', ['127.0.0.0/8'], true],
            ['127.1', ['127.0.0.1'], true],
            ['127.0.0.1', ['127.1'], true],
            ['0x7f000001', ['0177.0.0.1'], true],
            ['127.0.0.1', ['0x7f000000/8'], false],
            ['127.0.0.1', ['0177.0.0.0/8'], false],
            ['127.0.0.1', ['127/8'], false],
            ['0.0.0.127', ['127/8'], false],
            ['0.0.0.1', ['.1'], true],
            ['example.1', ['.1'], false],
            ['foo.2130706433', ['2130706433'], false],
            ['127.0.0.256', ['127.0.0.0/8'], false],
            ['0x100000000', ['0.0.0.0/0'], false],
            ['08', ['0.0.0.8'], false],
            ['1.2.3.4.5', ['1.2.3.0/24'], false],
            ['127.1.', ['127.1'], false],
        ];
    }
