...
/**
 * Verifies the message integrity based on a response header using a {@see HashInterface} object
 */
class ResponseIntegrityPlugin implements EventSubscriberInterface
{
    private $hash;
    private $header;
    private $sizeCutoff;
