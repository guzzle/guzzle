...
interface MessageFactoryInterface
{
     ...
     *       response to a PHP stream. Pass a {@see Guzzle\Stream\StreamInterface} object to stream the response body
     ...
     *       instance of {@see Guzzle\Common\EventSubscriberInterface}.
